...
class _LaundryDetailsScreenState extends State<LaundryDetailsScreen>
  ...
  Widget _buildServicesTab() {
    ...
    if (servicesResponse == null || servicesResponse!.services.isEmpty) {
      return const Center(
        child: Column(
    ...
    return ListView.builder(
      padding: const EdgeInsets.all(16),
      itemCount: servicesResponse!.services.length,
      itemBuilder: (context, index) {
        final serviceDetail = servicesResponse!.services[index];
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            'المدة: ${service.formattedDuration}',
                            style: TextStyle(
                              color: Colors.grey[600],
                              fontSize: 14,
                            ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (service.price != service.urgentPrice) ...[
                      const SizedBox(height: 4),
                      Text(
                        'عاجل: ${service.formattedUrgentPrice}',
                        style: TextStyle(
                          fontSize: 12,
                          color: Colors.grey[600],
                        ),
